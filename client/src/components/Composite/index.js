...
let imgPenguin = process.env.PUBLIC_URL + { imgURL }; // background image examples should all be the same size
let sweaterRaw = process.env.PUBLIC_URL + { imgURL }; // png layer
